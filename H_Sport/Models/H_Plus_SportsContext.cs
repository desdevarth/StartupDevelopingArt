...
namespace H_Sport.Models
{
    public partial class H_Plus_SportsContext : DbContext
    {
        ...
        public H_Plus_SportsContext(DbContextOptions<H_Plus_SportsContext> dbContextOptions):base(dbContextOptions)
        {
...
//                optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=H_Plus_Sports;Integrated Security=True");
//            }
//        }
